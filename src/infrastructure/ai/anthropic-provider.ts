...
export class AnthropicProvider implements AIProvider {
  ...
  async recommendForBrand(): Promise<string> {
    throw new Error('La recomendación estratégica de marca todavía no está implementada para Anthropic — usa OpenAI por ahora.');
  }

  async completeBrandProfile(): Promise<import('../../domain/shared/ai-provider').BrandProfileFields> {
    throw new Error('Completar perfil de marca todavía no está implementado para Anthropic — usa OpenAI por ahora.');
  }
